...
import com.proto.app.repository.DiningTableRepository;
import com.proto.app.service.DiningTableService;
...
public class DiningTableResourceIntTest {
    ...
    private static final String DEFAULT_TABLE_CODE = "AAAAAAAAAA";
    private static final String UPDATED_TABLE_CODE = "BBBBBBBBBB";
    ...
    public void createDiningTable() throws Exception {
        ...
        assertThat(testDiningTable.getTableCode()).isEqualTo(DEFAULT_TABLE_CODE);
    ...
    @Test
    @Transactional
    public void checkTableCodeIsRequired() throws Exception {
        int databaseSizeBeforeTest = diningTableRepository.findAll().size();
        // set the field null
        diningTable.setTableCode(null);
    ...
    public void getAllDiningTables() throws Exception {
        ...
        restDiningTableMockMvc.perform(get("/api/dining-tables?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].tableCode").value(hasItem(DEFAULT_TABLE_CODE.toString())));
    }
    ...
    public void getDiningTable() throws Exception {
        ...
        restDiningTableMockMvc.perform(get("/api/dining-tables/{id}", diningTable.getId()))
            ...
            .andExpect(jsonPath("$.tableCode").value(DEFAULT_TABLE_CODE.toString()));
    }
    ...
    public void updateDiningTable() throws Exception {
        ...
        assertThat(testDiningTable.getTableCode()).isEqualTo(UPDATED_TABLE_CODE);

    ...
    ngOnInit() {
        ...
        this.storeGroupService.query({filter: 'user-is-null'}).subscribe((res: Response) => {
            if (!this.businessUser.storeGroupId) {
                ...
                this.storeGroupService.find(this.businessUser.storeGroupId).subscribe((subRes: Response) => {
    ...
    save () {
        ...
        if (this.businessUser.id !== undefined) {
            this.businessUserService.update(this.businessUser)
                .subscribe((res: BusinessUser) => this.onSaveSuccess(res), (res: Response) => this.onSaveError(res.json()));
        } else {
